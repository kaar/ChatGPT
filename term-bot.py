...
def create_headers(session_token):
    ...
    try:
        # config["session_token"] = response.cookies.get(
        #     "__Secure-next-auth.session-token"
        # )
        authorization_token = response.json()["accessToken"]
...
class ChatBot:
    def __init__(self, session_token):
        ...
        self.headers = create_headers(self.session_token)
    ...
    def get_chat_response(self, prompt) -> dict:
        ...
        #     self.parent_id = response_json["parent_message_id"]
        #     return response_json
        # else:
        #     print("Error getting chat response")
        #     print(response.text)
        #     return {}
        # print(response.text)
        # print(response.json())
...
resp = cb.get_chat_response("Hello")
